...
class CameraCountdownScreen extends StatelessWidget {
  @override
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () {},
                        child: SvgPicture.asset(ImageConstant.watchCameraCountButton)),
                  ],
                ),
              ),
            ],
  ...
  onTapCameraPictureTakenScreen() {
    Get.toNamed(AppRoutes.cameraPictureTakenScreen);
  }
}
