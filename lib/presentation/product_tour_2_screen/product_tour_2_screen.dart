...
class ProductTour2Screen extends StatelessWidget {
  final PageController controller;

  const ProductTour2Screen({Key? key, required this.controller}) : super(key: key);
  @override
      ...
      children: [
        SizedBox(
          ...
          child: ColorFiltered(
            ...
            child: Image.asset(
              ImageConstant.introScreenImage2,
              fit: BoxFit.cover,
            ),
          ),
        ),
