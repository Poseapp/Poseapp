...
class HomeGlobalFeedScreen extends StatefulWidget {
  @override
  State<HomeGlobalFeedScreen> createState() => _HomeGlobalFeedScreen();
}


class _HomeGlobalFeedScreen extends State<HomeGlobalFeedScreen> {
