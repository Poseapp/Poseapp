...
class ProductTour1Screen extends StatelessWidget {
  final PageController controller;

  const ProductTour1Screen({Key? key, required this.controller})
      : super(key: key);
        ...
        SizedBox(
          ...
          child: ColorFiltered(
            colorFilter: ColorFilter.mode(
                Colors.transparent.withOpacity(0.4), BlendMode.hardLight),
            child: Image.asset(
              ImageConstant.introScreenImage1,
              fit: BoxFit.cover,
            ),
          ),
        ),
